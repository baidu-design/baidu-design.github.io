...
var customvue_type_template_id_c3d3ddf2_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('veui-button',{on:{"click":function($event){_vm.open = true}}},[_vm._v("删除")]),_c('veui-confirm-box',{attrs:{"title":"系统提示","open":_vm.open},on:{"update:open":function($event){_vm.open=$event},"ok":_vm.ok,"cancel":_vm.cancel}},[_c('p',[_vm._v("删除后不可恢复，确认删除？")])])],1)}
...
var postvue_type_style_index_0_id_38c00157_lang_stylus_scoped_true_ = __webpack_require__(826);
