...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('veui-breadcrumb',{attrs:{"routes":_vm.routes},on:{"redirect":_vm.handleRedirect}}),_c('div',{staticClass:"console"},[(_vm.currentRoute)?[_vm._v(" Redirected to "),_c('b',[_vm._v(_vm._s(_vm.currentRoute.label))]),_vm._v(". ")]:[_vm._v(" Not redirected yet. ")]],2)],1)}
var staticRenderFns = []
