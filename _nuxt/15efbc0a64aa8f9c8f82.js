...
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',{staticClass:"content post"},[_c('h1',{attrs:{"id":"浮层管理"}},[_vm._v("浮层管理")]),_vm._v(" "),_c('p',[_vm._v("在 VEUI 中，有大量组件使用到了浮层功能：")]),_vm._v(" "),_c('ul',[_c('li',[_vm._v("各种类型的弹框："),_c('a',{attrs:{"href":"../components/dialog"}},[_vm._v("对话框")]),_vm._v("、"),_c('a',{attrs:{"href":"../components/alert-box"}},[_vm._v("警告弹框")]),_vm._v("等；")]),_vm._v(" "),_c('li',[_c('a',{attrs:{"href":"../components/select"}},[_vm._v("下拉选择")]),_vm._v("；")]),_vm._v(" "),_c('li',[_vm._v("……")])]),_vm._v(" "),_c('p',[_vm._v("针对这些组件，我们抽离了具备如下功能的浮层模块：")]),_vm._v(" "),_c('ul',[_c('li',[_vm._v("能够浮于页面上所有普通元素之上；")]),_vm._v(" "),_c('li',[_vm._v("能够进行层叠顺序管理；")]),_vm._v(" "),_c('li',[_vm._v("能够基于指定元素定位。")])]),_vm._v(" "),_c('h2',{attrs:{"id":"层叠覆盖"}},[_vm._v("层叠覆盖")]),_vm._v(" "),_c('p',[_vm._v("为了避免浮层被上层 "),_c('code',[_vm._v("overflow: hidden")]),_vm._v(" 的元素意外遮盖，我们将浮层根元素直接置于 "),_c('code',[_vm._v("<body>")]),_vm._v(" 下统一管理。")]),_vm._v(" "),_c('p',[_vm._v("在"),_c('a',{attrs:{"href":"../components/overlay"}},[_vm._v("浮层组件")]),_vm._v("中，"),_c('code',[_vm._v(".veui-overlay-box")]),_vm._v(" 对应了浮层根元素，该元素在组件初始化的时候，会被放置到 "),_c('code',[_vm._v("<body>")]),_vm._v(" 之下，组件销毁的时候，会被移除掉。")]),_vm._v(" "),_c('h2',{attrs:{"id":"层叠顺序管理"}},[_vm._v("层叠顺序管理")]),_vm._v(" "),_c('p',[_vm._v("在将浮层根元素置于 "),_c('code',[_vm._v("<body>")]),_vm._v(" 下后，原有的层级嵌套关系会丢失，同时也无法通过原生的层叠上下文机制来控制浮层的层叠顺序。比如：")]),_vm._v(" "),_c('ul',[_c('li',[_vm._v("某个对话框组件 A 上有一个下拉选择组件 B，那么 B 组件浮层应该位于 A 组件浮层之上。")]),_vm._v(" "),_c('li',[_vm._v("警告框浮层应该位于普通对话框浮层之上。")])]),_vm._v(" "),_c('p',[_vm._v("基于上述限制，浮层模块实现了自己的层叠顺序管理机制。整个浮层层级嵌套关系，是通过一棵树来表达的：")]),_vm._v(" "),_c('figure',{staticClass:"hero"},[_c('div',{staticClass:"preview"},[_c('img',{staticClass:"hero",attrs:{"src":"/images/development/advanced/overlay-tree.png","srcset":"/images/development/advanced/overlay-tree.png" + " 2x"}})])]),_vm._v(" "),_c('p',[_vm._v("树中每一个蓝色节点都对应关联到具体的"),_c('a',{attrs:{"href":"../componnets/overlay"}},[_vm._v("浮层组件")]),_vm._v("实例。针对上图，树的构造顺序可以是：")]),_vm._v(" "),_c('ol',[_c('li',[_vm._v("弹出“对话框1”，创建一个“对话框1”节点，根据节点权重信息创建一个分组，然后将分组挂在 root 节点之下。")]),_vm._v(" "),_c('li',[_vm._v("弹出“对话框2”，创建一个“对话框2”节点，发现已经存在相同权重的分组，就直接将“对话框2”节点放置在该分组的末尾位置。")]),_vm._v(" "),_c('li',[_vm._v("在“对话框2”中实例化一个“下拉选择1”组件实例，由于“对话框2”组件实例是“下拉选择1”组件实例的父级，因此对应的浮层节点也应当具备父子关系，因此按照类似于“步骤1”的顺序在“对话框2”节点下生成分组及“下拉选择1”节点。")]),_vm._v(" "),_c('li',[_vm._v("此时由于程序运行出现了故障，弹出了“警告弹框1”，由于“警告弹框”类型的组件相对于“对话框”组件具备更高的层级权重，因此在 root 之下新建了一个靠右的分组，并将生成的“警告弹框1”节点置于分组末尾。")])]),_vm._v(" "),_c('p',[_vm._v("有了树之后，就会按照深度优先的遍历顺序生成每个节点的 "),_c('code',[_vm._v("z-index")]),_vm._v(" 值。")]),_vm._v(" "),_c('p',[_vm._v("其中，基准 "),_c('code',[_vm._v("z-index")]),_vm._v(" 值可以通过全局配置对象进行配置：")]),_vm._v(" "),_c('pre',[_c('code',{staticClass:"hljs language-js"},[_c('span',{staticClass:"hljs-keyword"},[_vm._v("import")]),_vm._v(" config "),_c('span',{staticClass:"hljs-keyword"},[_vm._v("from")]),_vm._v(" "),_c('span',{staticClass:"hljs-string"},[_vm._v("'veui/managers/config'")]),_vm._v("\n\nconfig.set("),_c('span',{staticClass:"hljs-string"},[_vm._v("'overlay.baseZIndex'")]),_vm._v(", "),_c('span',{staticClass:"hljs-number"},[_vm._v("200")]),_vm._v(")")])]),_vm._v(" "),_c('div',{staticClass:"warning custom-block"},[_c('p',[_vm._v("必须在"),_c('a',{attrs:{"href":"../components/overlay"}},[_vm._v("浮层组件")]),_vm._v("引入之前设置基准 "),_c('code',[_vm._v("z-index")]),_vm._v("，不然不会生效。")])]),_vm._v(" "),_c('p',[_vm._v("可以针对组件类型，甚至组件实例粒度设置层叠优先级，层叠优先级值越大，最终生成的 "),_c('code',[_vm._v("z-index")]),_vm._v(" 值就越大。具有相同层叠优先级的同级组件实例，越靠后实例化的组件，生成的 "),_c('code',[_vm._v("z-index")]),_vm._v(" 值越大。")]),_vm._v(" "),_c('p',[_vm._v("浮层组件、对话框组件、弹框组件等提供了 "),_c('code',[_vm._v("priority")]),_vm._v(" 属性，用于自定义组件实例的层叠优先级：")]),_vm._v(" "),_c('pre',[_c('code',{staticClass:"hljs language-html"},[_c('span',{staticClass:"hljs-tag"},[_vm._v("<"),_c('span',{staticClass:"hljs-name"},[_vm._v("veui-dialog")]),_vm._v(" "),_c('span',{staticClass:"hljs-attr"},[_vm._v(":priority")]),_vm._v("="),_c('span',{staticClass:"hljs-string"},[_vm._v("\"300\"")]),_vm._v("/>")])])]),_vm._v(" "),_c('p',[_vm._v("一些比较特殊的组件，会提供基于组件类型粒度的层叠优先级配置：")]),_vm._v(" "),_c('table',[_c('thead',[_c('tr',[_c('th',[_vm._v("组件")]),_c('th',[_vm._v("配置字段")]),_c('th',[_vm._v("默认值")]),_c('th',[_vm._v("修改配置示例")])])]),_c('tbody',[_c('tr',[_c('td',[_vm._v("警告弹框")]),_c('td',[_c('code',[_vm._v("alertbox.priority")])]),_c('td',[_c('code',[_vm._v("100")])]),_c('td',[_c('pre',[_c('code',{staticClass:"hljs language-js"},[_c('span',{staticClass:"hljs-keyword"},[_vm._v("import")]),_vm._v(" config "),_c('span',{staticClass:"hljs-keyword"},[_vm._v("from")]),_vm._v(" "),_c('span',{staticClass:"hljs-string"},[_vm._v("'veui/managers/config'")]),_vm._v("\n\nconfig.set("),_c('span',{staticClass:"hljs-string"},[_vm._v("'alertbox.priority'")]),_vm._v(", "),_c('span',{staticClass:"hljs-number"},[_vm._v("100")]),_vm._v(")")])])])]),_c('tr',[_c('td',[_vm._v("确认弹框")]),_c('td',[_c('code',[_vm._v("confirmbox.priority")])]),_c('td',[_c('code',[_vm._v("100")])]),_c('td',[_c('pre',[_c('code',{staticClass:"hljs language-js"},[_c('span',{staticClass:"hljs-keyword"},[_vm._v("import")]),_vm._v(" config "),_c('span',{staticClass:"hljs-keyword"},[_vm._v("from")]),_vm._v(" "),_c('span',{staticClass:"hljs-string"},[_vm._v("'veui/managers/config'")]),_vm._v("\n\nconfig.set("),_c('span',{staticClass:"hljs-string"},[_vm._v("'confirmbox.priority'")]),_vm._v(", "),_c('span',{staticClass:"hljs-number"},[_vm._v("100")]),_vm._v(")")])])])]),_c('tr',[_c('td',[_vm._v("输入弹框")]),_c('td',[_c('code',[_vm._v("promptbox.priority")])]),_c('td',[_c('code',[_vm._v("100")])]),_c('td',[_c('pre',[_c('code',{staticClass:"hljs language-js"},[_c('span',{staticClass:"hljs-keyword"},[_vm._v("import")]),_vm._v(" config "),_c('span',{staticClass:"hljs-keyword"},[_vm._v("from")]),_vm._v(" "),_c('span',{staticClass:"hljs-string"},[_vm._v("'veui/managers/config'")]),_vm._v("\n\nconfig.set("),_c('span',{staticClass:"hljs-string"},[_vm._v("'promptbox.priority'")]),_vm._v(", "),_c('span',{staticClass:"hljs-number"},[_vm._v("100")]),_vm._v(")")])])])])])]),_vm._v(" "),_c('p',[_vm._v("总结起来，确定某个浮层系组件实例的层叠优先级的逻辑流程为：")]),_vm._v(" "),_c('ul',[_c('li',[_vm._v("如果能够设置组件实例级别的层叠优先级，并且设置了，那么就使用这个层叠优先级值，否则进入下一步；")]),_vm._v(" "),_c('li',[_vm._v("如果能够设置组件类型级别的层叠优先级，并且设置了，那么就使用这个层叠优先级值，否则进入下一步；")]),_vm._v(" "),_c('li',[_vm._v("使用默认的层叠优先级值："),_c('code',[_vm._v("1")]),_vm._v("。")])]),_vm._v(" "),_c('h2',{attrs:{"id":"定位"}},[_vm._v("定位")]),_vm._v(" "),_c('p',[_vm._v("VEUI 中，浮层支持两种定位方式：")]),_vm._v(" "),_c('ul',[_c('li',[_vm._v("在页面范围内，以坐标值的形式进行定位；")]),_vm._v(" "),_c('li',[_vm._v("相对于某个元素，指定偏移和变换规则进行定位。")])]),_vm._v(" "),_c('p',[_vm._v("以坐标方式定位时，需要自己写 CSS 进行控制（浮层模块内部只会生成浮层根元素的 "),_c('code',[_vm._v("z-index")]),_vm._v(" 值）。")]),_vm._v(" "),_c('p',[_vm._v("相对元素定位时，可以通过"),_c('a',{attrs:{"href":"../components/overlay"}},[_vm._v("浮层组件")]),_vm._v("的 "),_c('code',[_vm._v("options")]),_vm._v(" 属性描述偏移和变换规则。由于目前内部采用 "),_c('a',{attrs:{"href":"http://tether.io/"}},[_vm._v("Tether")]),_vm._v(" 实现，因此完整的配置项可以参考 "),_c('a',{attrs:{"href":"http://tether.io/#options"}},[_vm._v("Tether 官网")]),_vm._v("。同时，也支持一些常见场景的简化配置："),_c('code',[_vm._v("{ position: `${side}-${align}` }")]),_vm._v("，"),_c('code',[_vm._v("side")]),_vm._v(" 表示浮层根元素位于目标元素哪一边（"),_c('code',[_vm._v("top")]),_vm._v("/"),_c('code',[_vm._v("right")]),_vm._v("/"),_c('code',[_vm._v("bottom")]),_vm._v("/"),_c('code',[_vm._v("left")]),_vm._v("），"),_c('code',[_vm._v("align")]),_vm._v(" 表示对齐方式（"),_c('code',[_vm._v("start")]),_vm._v("/"),_c('code',[_vm._v("end")]),_vm._v("）。其中 "),_c('code',[_vm._v("side")]),_vm._v(" 是必须的，"),_c('code',[_vm._v("align")]),_vm._v(" 不传表示居中。推荐尽量使用简化的配置。")]),_vm._v(" "),_c('h2',{attrs:{"id":"样式"}},[_vm._v("样式")]),_vm._v(" "),_c('p',[_vm._v("由于浮层根元素被手动放置到 "),_c('code',[_vm._v("<body>")]),_vm._v(" 元素之下了，要设置浮层内容的样式，就需要给浮层根元素指定 "),_c('code',[_vm._v("class")]),_vm._v("。所有浮层系组件都支持 "),_c('code',[_vm._v("overlay-class")]),_vm._v(" 属性，通过该属性为浮层根元素设置 "),_c('code',[_vm._v("class")]),_vm._v("：")]),_vm._v(" "),_c('pre',[_c('code',{staticClass:"hljs language-vue"},[_c('span',{staticClass:"hljs-tag"},[_vm._v("<"),_c('span',{staticClass:"hljs-name"},[_vm._v("template")]),_vm._v(">")]),_c('span',{staticClass:"html"},[_vm._v("\n  "),_c('span',{staticClass:"hljs-tag"},[_vm._v("<"),_c('span',{staticClass:"hljs-name"},[_vm._v("veui-dialog")]),_vm._v(" "),_c('span',{staticClass:"hljs-attr"},[_vm._v("overlay-class")]),_vm._v("="),_c('span',{staticClass:"hljs-string"},[_vm._v("\"my-dialog-overlay\"")]),_vm._v("/>")]),_vm._v("\n"),_c('span',{staticClass:"hljs-tag"},[_vm._v("<"),_c('span',{staticClass:"hljs-name"},[_vm._v("template")]),_vm._v(">")]),_vm._v("\n\n"),_c('span',{staticClass:"hljs-tag"},[_vm._v("<"),_c('span',{staticClass:"hljs-name"},[_vm._v("style")]),_vm._v(">")]),_c('span',{staticClass:"css"},[_vm._v("\n"),_c('span',{staticClass:"hljs-selector-class"},[_vm._v(".my-dialg-overlay")]),_vm._v(" {\n  "),_c('span',{staticClass:"hljs-comment"},[_vm._v("/* 自定义浮层样式 */")]),_vm._v("\n}\n")]),_c('span',{staticClass:"hljs-tag"},[_vm._v("</"),_c('span',{staticClass:"hljs-name"},[_vm._v("style")]),_vm._v(">")])])])])])}]
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/veui-loader/lib??ref--14!./pages/advanced/overlay.vue?vue&type=script&lang=js&
//
//
//
//
...
var postvue_type_style_index_0_id_2862205c_lang_stylus_scoped_true_ = __webpack_require__(950);
