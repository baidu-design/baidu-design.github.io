...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('veui-button',{on:{"click":function($event){_vm.open = true}}},[_vm._v("Prompt")]),_vm._v(" "),_c('veui-prompt-box',{attrs:{"title":"Survey","open":_vm.open},on:{"update:open":function($event){_vm.open=$event},"cancel":_vm.cancel,"ok":_vm.ok},model:{value:(_vm.value),callback:function ($$v) {_vm.value=$$v},expression:"value"}},[_vm._v("\n    What's your favorite food?\n  ")])],1)}
var staticRenderFns = []
