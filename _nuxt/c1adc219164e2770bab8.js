...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('veui-button',{on:{"click":function($event){return _vm.$toast.info({
    ...
    duration: 5000
  })}}},[_vm._v("Info")]),_c('veui-button',{on:{"click":function($event){return _vm.$toast.success('Your profile has been updated.')}}},[_vm._v("Success")]),_c('veui-button',{on:{"click":function($event){return _vm.$toast.warn('scope is deprecated. Use slot-scope instead.')}}},[_vm._v("Warn")]),_c('veui-button',{on:{"click":function($event){return _vm.$toast.error('Uncaught SyntaxError: Unexpected token +')}}},[_vm._v("Error")])],1)}
var staticRenderFns = []
