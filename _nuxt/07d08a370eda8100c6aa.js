...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('veui-button',{on:{"click":function($event){_vm.open = true}}},[_vm._v("Remove")]),_vm._v(" "),_c('veui-confirm-box',{attrs:{"title":"System Notification","open":_vm.open},on:{"update:open":function($event){_vm.open=$event},"ok":_vm.ok,"cancel":_vm.cancel}},[_c('p',[_vm._v("Are you sure to remove the item?")])])],1)}
var staticRenderFns = []
