...
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',{staticClass:"content post"},[_c('h1',{attrs:{"id":"主题"}},[_vm._v("主题")]),_c('p',[_vm._v("VEUI 的组件和主题包是完全解耦的。组件库中不含有任何样式代码，每个组件的样式都需要主题包中对应的样式文件来提供。")]),_c('p',[_vm._v("为了方便在按需引入的同时不需要手动引入每个组件的样式代码，我们提供了 veui-loader 来完成通过配置自动将依赖的样式文件注入组件，详情请参考 veui-loader 的"),_c('a',{attrs:{"href":"../getting-started/veui-loader"}},[_vm._v("相关介绍")]),_vm._v("。")]),_c('h2',{attrs:{"id":"创建自定义主题包"}},[_vm._v("创建自定义主题包")]),_c('p',[_vm._v("veui-loader 为 VEUI 注入依赖时，同时支持注入 script 类型及 style 类型的模块。所以主题包中可以为每个组件提供这两种类型的主题配置。")]),_c('h3',{attrs:{"id":"自定义样式"}},[_vm._v("自定义样式")]),_c('div',{staticClass:"warning custom-block"},[_c('p',[_vm._v("注意，主题包样式对 VEUI 组件的 DOM 结构会有依赖。")])]),_c('p',[_vm._v("为每个组件提供完整的样式，可以使用任何预处理语言。每个组件具体提供的类名及选择器可以参考 veui-theme-one 中的实现。")]),_c('pre',[_c('code',{staticClass:"hljs language-less"},[_c('span',{staticClass:"hljs-selector-class"},[_vm._v(".veui-button")]),_vm._v(" { "),_c('span',{staticClass:"hljs-comment"},[_vm._v("/* ... */")]),_vm._v(" }")])]),_c('h3',{attrs:{"id":"自定义图标"}},[_vm._v("自定义图标")]),_c('p',[_vm._v("VEUI 的 "),_c('code',[_vm._v("Icon")]),_vm._v(" 组件封装了 "),_c('a',{attrs:{"href":"https://justineo.github.io/vue-awesome/demo/"}},[_vm._v("Vue-Awesome")]),_vm._v(" 来输出内联 SVG 图标，无法直接在样式代码中指定，需要通过 script 模块进行注册。每个组件都定义了语义明确的图标接口，我们需要做的只是在全局配置中为组件注入相应的图标名称映射并引入对应的图标模块：")]),_c('pre',[_c('code',{staticClass:"hljs language-js"},[_c('span',{staticClass:"hljs-keyword"},[_vm._v("import")]),_vm._v(" config "),_c('span',{staticClass:"hljs-keyword"},[_vm._v("from")]),_vm._v(" "),_c('span',{staticClass:"hljs-string"},[_vm._v("'veui/managers/config'")]),_vm._v(" "),_c('span',{staticClass:"hljs-keyword"},[_vm._v("import")]),_vm._v(" "),_c('span',{staticClass:"hljs-string"},[_vm._v("'../icons/angle-up-small'")]),_vm._v(" "),_c('span',{staticClass:"hljs-keyword"},[_vm._v("import")]),_vm._v(" "),_c('span',{staticClass:"hljs-string"},[_vm._v("'../icons/angle-down-small'")]),_vm._v(" config.defaults({ "),_c('span',{staticClass:"hljs-attr"},[_vm._v("icons")]),_vm._v(": { "),_c('span',{staticClass:"hljs-attr"},[_vm._v("expand")]),_vm._v(": "),_c('span',{staticClass:"hljs-string"},[_vm._v("'angle-down-small'")]),_vm._v(", "),_c('span',{staticClass:"hljs-attr"},[_vm._v("collapse")]),_vm._v(": "),_c('span',{staticClass:"hljs-string"},[_vm._v("'angle-up-small'")]),_vm._v(" } }, "),_c('span',{staticClass:"hljs-string"},[_vm._v("'select'")]),_vm._v(")")])]),_c('p',[_vm._v("除了 veui-theme-one 自带的图标外，目前可以使用的图标包还有：")]),_c('ul',[_c('li',[_c('a',{attrs:{"href":"https://justineo.github.io/vue-awesome/demo/"}},[_c('code',[_vm._v("vue-awesome/icons")])]),_vm._v("：Vue-Awesome 自带 "),_c('a',{attrs:{"href":"https://fontawesome.com/"}},[_vm._v("FontAwesome")]),_vm._v(" 图标包")]),_c('li',[_c('a',{attrs:{"href":"https://justineo.github.io/vue-awesome-material-icons/demo/"}},[_c('code',[_vm._v("vue-awesome-material-icons/icons")])]),_vm._v("：同样基于 Vue-Awesome 的 "),_c('a',{attrs:{"href":"https://material.io/tools/icons"}},[_vm._v("Material Icons")]),_vm._v(" 图标包")])]),_c('h3',{attrs:{"id":"预设样式及自定义配置"}},[_vm._v("预设样式及自定义配置")]),_c('p',[_vm._v("VEUI 中各个组件的可切换的预设样式是通过为主题包提供可扩展的 "),_c('code',[_vm._v("ui")]),_vm._v(" 配置实现的。")]),_c('p',[_vm._v("新增一个预设样式 "),_c('code',[_vm._v("foo")]),_vm._v(" 只需要在样式文件中添加 "),_c('code',[_vm._v("[ui~=\"foo\"]")]),_vm._v(" 对应的样式并在使用组件时添加对应的 "),_c('code',[_vm._v("ui=\"foo\"")]),_vm._v(" 声明即可完成：")]),_c('pre',[_c('code',{staticClass:"hljs language-less"},[_c('span',{staticClass:"hljs-selector-class"},[_vm._v(".veui-select")]),_vm._v(" { "),_c('span',{staticClass:"hljs-comment"},[_vm._v("/* ... */")]),_vm._v(" "),_c('span',{staticClass:"hljs-selector-tag"},[_vm._v("&")]),_c('span',{staticClass:"hljs-selector-attr"},[_vm._v("[ui~=\"foo\"]")]),_vm._v(" { "),_c('span',{staticClass:"hljs-attribute"},[_vm._v("color")]),_vm._v(": "),_c('span',{staticClass:"hljs-number"},[_vm._v("#f00")]),_vm._v("; } }")])]),_c('pre',[_c('code',{staticClass:"hljs language-html"},[_c('span',{staticClass:"hljs-tag"},[_vm._v("<"),_c('span',{staticClass:"hljs-name"},[_vm._v("veui-select")]),_vm._v(" "),_c('span',{staticClass:"hljs-attr"},[_vm._v("ui")]),_vm._v("="),_c('span',{staticClass:"hljs-string"},[_vm._v("\"foo\"")]),_vm._v(">")]),_vm._v("..."),_c('span',{staticClass:"hljs-tag"},[_vm._v("</"),_c('span',{staticClass:"hljs-name"},[_vm._v("veui-select")]),_vm._v(">")])])]),_c('p',[_vm._v("一个组件也可以同时应用多个预设样式：")]),_c('pre',[_c('code',{staticClass:"hljs language-html"},[_c('span',{staticClass:"hljs-tag"},[_vm._v("<"),_c('span',{staticClass:"hljs-name"},[_vm._v("veui-select")]),_vm._v(" "),_c('span',{staticClass:"hljs-attr"},[_vm._v("ui")]),_vm._v("="),_c('span',{staticClass:"hljs-string"},[_vm._v("\"foo bar\"")]),_vm._v(">")]),_vm._v("..."),_c('span',{staticClass:"hljs-tag"},[_vm._v("</"),_c('span',{staticClass:"hljs-name"},[_vm._v("veui-select")]),_vm._v(">")])])]),_c('p',[_vm._v("但如果我们想将预设样式定义得更完善一些，比如 "),_c('code',[_vm._v("foo")]),_vm._v(" 与 "),_c('code',[_vm._v("bar")]),_vm._v(" 是组件的两种不可同时使用的预设样式怎么办呢？比如 "),_c('code',[_vm._v("small")]),_vm._v(" 和 "),_c('code',[_vm._v("large")]),_vm._v(" 样式都会自定义组件的尺寸，是互斥的，我们就需要通过在全局配置中为组件注入更详细的 "),_c('code',[_vm._v("ui")]),_vm._v(" 配置来实现。")]),_c('p',[_c('code',[_vm._v("ui")]),_vm._v(" 字段下每个属性名都是需要声明的预设样式名称，其值的类型为："),_c('code',[_vm._v("{ values, boolean, inherit }")]),_vm._v("。")]),_c('p',[_vm._v("字段详情：")]),_c('table',[_c('thead',[_c('tr',[_c('th',[_vm._v("名称")]),_c('th',[_vm._v("类型")]),_c('th',[_vm._v("默认值")]),_c('th',[_vm._v("描述")])])]),_c('tbody',[_c('tr',[_c('td',[_c('code',[_vm._v("values")])]),_c('td',[_c('code',[_vm._v("Array<string>")])]),_c('td',[_vm._v("-")]),_c('td',[_vm._v("预设 "),_c('code',[_vm._v("ui")]),_vm._v(" 属性的可选值。")])]),_c('tr',[_c('td',[_c('code',[_vm._v("boolean")])]),_c('td',[_c('code',[_vm._v("boolean")])]),_c('td',[_c('code',[_vm._v("false")])]),_c('td',[_vm._v("预设 "),_c('code',[_vm._v("ui")]),_vm._v(" 属性是否为布尔型。")])]),_c('tr',[_c('td',[_c('code',[_vm._v("inherit")])]),_c('td',[_c('code',[_vm._v("boolean")])]),_c('td',[_c('code',[_vm._v("false")])]),_c('td',[_vm._v("预设 "),_c('code',[_vm._v("ui")]),_vm._v(" 属性值是否会被子组件继承。")])])])]),_c('p',[_vm._v("以 "),_c('code',[_vm._v("Select")]),_vm._v(" 组件为例：")]),_c('pre',[_c('code',{staticClass:"hljs language-js"},[_c('span',{staticClass:"hljs-keyword"},[_vm._v("import")]),_vm._v(" config "),_c('span',{staticClass:"hljs-keyword"},[_vm._v("from")]),_vm._v(" "),_c('span',{staticClass:"hljs-string"},[_vm._v("'veui/managers/config'")]),_vm._v(" config.defaults({ "),_c('span',{staticClass:"hljs-attr"},[_vm._v("ui")]),_vm._v(": { "),_c('span',{staticClass:"hljs-attr"},[_vm._v("size")]),_vm._v(": { "),_c('span',{staticClass:"hljs-attr"},[_vm._v("values")]),_vm._v(": ["),_c('span',{staticClass:"hljs-string"},[_vm._v("'large'")]),_vm._v(", "),_c('span',{staticClass:"hljs-string"},[_vm._v("'small'")]),_vm._v(", "),_c('span',{staticClass:"hljs-string"},[_vm._v("'tiny'")]),_vm._v(", "),_c('span',{staticClass:"hljs-string"},[_vm._v("'micro'")]),_vm._v("], "),_c('span',{staticClass:"hljs-attr"},[_vm._v("inherit")]),_vm._v(": "),_c('span',{staticClass:"hljs-literal"},[_vm._v("true")]),_vm._v(" }, "),_c('span',{staticClass:"hljs-attr"},[_vm._v("style")]),_vm._v(": { "),_c('span',{staticClass:"hljs-attr"},[_vm._v("values")]),_vm._v(": ["),_c('span',{staticClass:"hljs-string"},[_vm._v("'alt'")]),_vm._v("] } } }, "),_c('span',{staticClass:"hljs-string"},[_vm._v("'select'")]),_vm._v(")")])]),_c('p',[_vm._v("在上面这个例子中，我们定义了两个 "),_c('code',[_vm._v("ui")]),_vm._v(" 属性："),_c('code',[_vm._v("size")]),_vm._v(" 和 "),_c('code',[_vm._v("style")]),_vm._v("。它们都是枚举类型，其中 "),_c('code',[_vm._v("size")]),_vm._v(" 值可被子组件继承。最终调用 "),_c('code',[_vm._v("Select")]),_vm._v(" 组件时，可以这样启用预设样式：")]),_c('pre',[_c('code',{staticClass:"hljs language-html"},[_c('span',{staticClass:"hljs-tag"},[_vm._v("<"),_c('span',{staticClass:"hljs-name"},[_vm._v("veui-select")]),_vm._v(" "),_c('span',{staticClass:"hljs-attr"},[_vm._v("ui")]),_vm._v("="),_c('span',{staticClass:"hljs-string"},[_vm._v("\"alt small\"")]),_vm._v(">")]),_vm._v("..."),_c('span',{staticClass:"hljs-tag"},[_vm._v("</"),_c('span',{staticClass:"hljs-name"},[_vm._v("veui-select")]),_vm._v(">")])])]),_c('p',[_vm._v("当然，我们也可以完全不定义 "),_c('code',[_vm._v("ui")]),_vm._v(" 属性的详情，这时 VEUI 会将用户书写的 "),_c('code',[_vm._v("ui")]),_vm._v(" 属性原样输出，不会进行去重、同属性的属性值冲突检测、继承等特殊处理。")]),_c('div',{staticClass:"warning custom-block"},[_c('p',[_vm._v("由于 "),_c('code',[_vm._v("ui")]),_vm._v(" 属性最后会将值打平输出到 DOM 元素上，所以各个属性的值不能冲突。")])]),_c('h3',{attrs:{"id":"指定组件内部组件的预设样式"}},[_vm._v("指定组件内部组件的预设样式")]),_c('p',[_vm._v("有一些组件由多个其它组件组合而成，此时我们可能会需要全局指定内部特定部件的预设样式。比如在 veui-theme-one 中，"),_c('code',[_vm._v("Dialog")]),_vm._v(" 中的取消按钮默认采用默认样式，而如果在其它主题中我们可能会想重置为 "),_c('code',[_vm._v("link")]),_vm._v(" 样式。此时可以使用全局配置修改组件的 "),_c('code',[_vm._v("parts")]),_vm._v(" 映射。")]),_c('pre',[_c('code',{staticClass:"hljs language-js"},[_c('span',{staticClass:"hljs-keyword"},[_vm._v("import")]),_vm._v(" config "),_c('span',{staticClass:"hljs-keyword"},[_vm._v("from")]),_vm._v(" "),_c('span',{staticClass:"hljs-string"},[_vm._v("'veui/managers/config'")]),_vm._v(" config.defaults({ "),_c('span',{staticClass:"hljs-attr"},[_vm._v("parts")]),_vm._v(": { "),_c('span',{staticClass:"hljs-attr"},[_vm._v("ok")]),_vm._v(": "),_c('span',{staticClass:"hljs-string"},[_vm._v("'primary'")]),_vm._v(", "),_c('span',{staticClass:"hljs-attr"},[_vm._v("cancel")]),_vm._v(": "),_c('span',{staticClass:"hljs-string"},[_vm._v("'link'")]),_vm._v(" } }, "),_c('span',{staticClass:"hljs-string"},[_vm._v("'select'")]),_vm._v(")")])]),_c('h2',{attrs:{"id":"主题包列表"}},[_vm._v("主题包列表")]),_c('ul',[_c('li',[_c('a',{attrs:{"href":"https://github.com/ecomfe/veui/tree/dev/packages/veui-theme-one"}},[_vm._v("veui-theme-one")]),_vm._v("：基于 ONE DESIGN 的 VEUI 主题")]),_c('li',[_c('a',{attrs:{"href":"https://github.com/ecomfe/veui-theme-blue"}},[_vm._v("veui-theme-blue")]),_vm._v("：基于 Theme Blue 的 VEUI 主题")]),_c('li',[_c('a',{attrs:{"href":"https://justineo.github.io/veui-theme-spectre/demo/"}},[_vm._v("veui-theme-spectre")]),_vm._v("：基于 Spectre.css 的 VEUI 主题")])])])}]
