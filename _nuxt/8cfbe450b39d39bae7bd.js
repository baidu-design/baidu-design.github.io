...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('veui-transfer',{attrs:{"datasource":_vm.coffees,"selected-show-mode":"flat"},model:{value:(_vm.selected),callback:function ($$v) {_vm.selected=$$v},expression:"selected"}}),_vm._v(" "),_c('p',[_vm._v("Selected: "+_vm._s(_vm.selected))])],1)}
var staticRenderFns = []
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('veui-transfer',{attrs:{"datasource":_vm.coffees,"filter":_vm.filter},model:{value:(_vm.selected),callback:function ($$v) {_vm.selected=$$v},expression:"selected"}}),_vm._v(" "),_c('p',[_vm._v("Selected: "+_vm._s(_vm.selected))])],1)}
var staticRenderFns = []
...
var custom_searchvue_type_custom_index_0_blockType_docs = __webpack_require__(1177);
...
var custom_searchvue_type_custom_index_1_blockType_docs_locale_en_US = __webpack_require__(1178);
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('veui-transfer',{attrs:{"datasource":_vm.coffees,"searchable":false},model:{value:(_vm.selected),callback:function ($$v) {_vm.selected=$$v},expression:"selected"}}),_vm._v(" "),_c('p',[_vm._v("Selected: "+_vm._s(_vm.selected))])],1)}
var staticRenderFns = []
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('veui-transfer',{attrs:{"datasource":_vm.coffees},model:{value:(_vm.selected),callback:function ($$v) {_vm.selected=$$v},expression:"selected"}}),_vm._v(" "),_c('p',[_vm._v("Selected: "+_vm._s(_vm.selected))])],1)}
var staticRenderFns = []
