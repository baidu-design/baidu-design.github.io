...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('section',[_c('veui-table',{attrs:{"data":_vm.data,"expandable":"","key-field":"id"}},[_c('veui-table-column',{attrs:{"field":"id","title":"ID"}}),_vm._v(" "),_c('veui-table-column',{attrs:{"field":"name","title":"Name"}}),_vm._v(" "),_c('veui-table-column',{attrs:{"field":"bid","title":"Bid","width":"160","align":"right"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var bid = ref.bid;
return [_vm._v(_vm._s(_vm._f("currency")(bid)))]}}])}),_vm._v(" "),_c('veui-table-column',{attrs:{"field":"updateDate","title":"Last updated","align":"center"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('section',[_c('veui-button',{attrs:{"ui":"primary"},on:{"click":_vm.append}},[_vm._v("Add")])],1),_vm._v(" "),_c('section',[_c('veui-checkbox',{attrs:{"true-value":"multiple","false-value":"single"},model:{value:(_vm.mode),callback:function ($$v) {_vm.mode=$$v},expression:"mode"}},[_vm._v("Multiple selection")]),_vm._v(" "),_c('veui-checkbox',{model:{value:(_vm.showOps),callback:function ($$v) {_vm.showOps=$$v},expression:"showOps"}},[_vm._v("Display “Operations”")]),_vm._v(" "),_c('veui-checkbox',{model:{value:(_vm.selectSpanRow),callback:function ($$v) {_vm.selectSpanRow=$$v},expression:"selectSpanRow"}},[_vm._v("Select by “Group” "),_c('small',[_vm._v("(instead of “ID”)")])])],1),_vm._v(" "),_c('section',[_c('veui-table',{attrs:{"ui":"alt bordered","data":_vm.data,"key-field":_vm.selectSpanRow ? 'group' : 'id',"selectable":"","select-mode":_vm.mode,"order-by":_vm.orderBy,"order":_vm.order,"selected":_vm.selected},on:{"sort":_vm.handleSort,"update:selected":function($event){_vm.selected=$event}}},[_c('veui-table-column',{attrs:{"field":"id","title":"ID","sortable":""}},[_c('template',{slot:"head"},[_c('strong',[_vm._v("ID")])]),_vm._v(" "),_c('template',{slot:"foot"},[_c('strong',[_vm._v("Total")])])],2),_vm._v(" "),_c('veui-table-column',{attrs:{"field":"group","title":"Group","span":_vm.groupSpan}}),_vm._v(" "),_c('veui-table-column',{attrs:{"field":"name","title":"Name","width":"160"}}),_vm._v(" "),_c('veui-table-column',{attrs:{"field":"bid","title":"Bid","sortable":"","width":"160","align":"right"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var bid = ref.bid;
return [_vm._v(_vm._s(_vm._f("currency")(bid)))]}}])},[_vm._v(" "),_c('template',{slot:"foot"},[_c('strong',[_vm._v(_vm._s(_vm._f("currency")(_vm.total)))])])],2),_vm._v(" "),_c('veui-table-column',{attrs:{"field":"updateDate","title":"Last updated","align":"center"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var id = ref.id;
var updateDate = ref.updateDate;
return [_c('span',{ref:("time-a-" + id)},[_vm._v(_vm._s(_vm._f("date")(updateDate)))]),_vm._v(" "),_c('veui-tooltip',{attrs:{"target":("time-a-" + id)}},[_vm._v(_vm._s(_vm._f("time")(updateDate)))])]}}])}),_vm._v(" "),(_vm.showOps)?_c('veui-table-column',{attrs:{"field":"operation","title":"Opertaions"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var index = ref.index;
return [_c('veui-button',{attrs:{"ui":"link alert"},on:{"click":function($event){return _vm.del(index)}}},[_vm._v("Remove")])]}}],null,false,297443017)}):_vm._e()],1),_vm._v(" "),_c('p',[_vm._v("Selected: "+_vm._s(JSON.stringify(_vm.selected)))])],1)])}
var staticRenderFns = []
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('section',[_c('veui-checkbox',{model:{value:(_vm.slim),callback:function ($$v) {_vm.slim=$$v},expression:"slim"}},[_vm._v("Slim")]),_vm._v(" "),_c('veui-checkbox',{model:{value:(_vm.alt),callback:function ($$v) {_vm.alt=$$v},expression:"alt"}},[_vm._v("Alternative")]),_vm._v(" "),_c('veui-checkbox',{model:{value:(_vm.bordered),callback:function ($$v) {_vm.bordered=$$v},expression:"bordered"}},[_vm._v("Bordered")])],1),_vm._v(" "),_c('section',[_c('veui-table',{attrs:{"ui":_vm.ui,"data":_vm.data,"key-field":"id"}},[_c('veui-table-column',{attrs:{"field":"id","title":"ID"}}),_vm._v(" "),_c('veui-table-column',{attrs:{"field":"name","title":"Name"}}),_vm._v(" "),_c('veui-table-column',{attrs:{"field":"bid","title":"Bid","width":"160","align":"right"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var bid = ref.bid;
return [_vm._v(_vm._s(_vm._f("currency")(bid)))]}}])}),_vm._v(" "),_c('veui-table-column',{attrs:{"field":"updateDate","title":"Last updated","align":"center"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var updateDate = ref.updateDate;
return [_vm._v(_vm._s(_vm._f("date")(updateDate)))]}}])}),_vm._v(" "),_c('veui-table-column',{attrs:{"field":"operation","title":"Operations"},scopedSlots:_vm._u([{key:"default",fn:function(ref){
var index = ref.index;
