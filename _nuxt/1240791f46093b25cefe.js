...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('veui-button',{on:{"click":function($event){_vm.modalOpen = true}}},[_vm._v("Modal")]),_vm._v(" "),_c('veui-button',{on:{"click":function($event){_vm.nonModalOpen = true}}},[_vm._v("Non-modal")]),_vm._v(" "),_c('veui-dialog',{attrs:{"title":"System","open":_vm.modalOpen},on:{"update:open":function($event){_vm.modalOpen=$event},"ok":function($event){return _vm.handleModalClose(true)},"cancel":_vm.handleModalClose}},[_vm._v("\n    Do you want to refresh the page?\n  ")]),_vm._v(" "),_c('veui-dialog',{attrs:{"title":"System","open":_vm.nonModalOpen,"modal":false},on:{"update:open":function($event){_vm.nonModalOpen=$event},"ok":function($event){return _vm.handleModalClose(true)},"cancel":_vm.handleModalClose}},[_vm._v("\n    Do you want to refresh the page?\n  ")])],1)}
var staticRenderFns = []
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('veui-button',{on:{"click":function($event){_vm.simpleOpen = true}}},[_vm._v("Title & content")]),_vm._v(" "),_c('veui-dialog',{attrs:{"open":_vm.simpleOpen,"title":"Customized Title & Content"},on:{"update:open":function($event){_vm.simpleOpen=$event},"ok":function($event){_vm.simpleOpen = false},"cancel":function($event){_vm.simpleOpen = false}}},[_vm._v("\n    Customized content via "),_c('code',[_vm._v("<slot>")]),_vm._v(".\n  ")]),_vm._v(" "),_c('veui-button',{on:{"click":function($event){_vm.titleIconOpen = true}}},[_vm._v("Icon in Title")]),_vm._v(" "),_c('veui-dialog',{attrs:{"open":_vm.titleIconOpen},on:{"update:open":function($event){_vm.titleIconOpen=$event},"ok":function($event){_vm.titleIconOpen = false},"cancel":function($event){_vm.titleIconOpen = false}}},[_c('template',{slot:"title"},[_vm._v("Title with Icon "),_c('veui-icon',{attrs:{"name":"top"}})],1),_vm._v("\n    Customized content via "),_c('code',[_vm._v("<slot>")]),_vm._v(".\n  ")],2),_vm._v(" "),_c('veui-button',{on:{"click":function($event){_vm.footOpen = true}}},[_vm._v("Foot")]),_vm._v(" "),_c('veui-dialog',{attrs:{"open":_vm.footOpen,"title":"Customized Foot"},on:{"update:open":function($event){_vm.footOpen=$event}},scopedSlots:_vm._u([{key:"foot",fn:function(ref){
var close = ref.close;
return [_c('veui-button',{attrs:{"ui":"small primary"},on:{"click":function($event){return close('ok')}}},[_vm._v("Close")])]}}])},[_vm._v("\n    Customized content via "),_c('code',[_vm._v("<slot>")]),_vm._v(".\n    ")])],1)}
var staticRenderFns = []
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('veui-button',{attrs:{"disabled":_vm.submitting},on:{"click":function($event){_vm.submitOpen = true}}},[_vm._v("Submit")]),_vm._v(" "),_c('veui-button',{attrs:{"disabled":_vm.saving},on:{"click":function($event){_vm.saveOpen = true}}},[_vm._v("Save")]),_vm._v(" "),_c('veui-dialog',{attrs:{"title":"System","open":_vm.submitOpen,"before-close":_vm.submit,"closable":false,"escapable":!_vm.submitting},on:{"update:open":function($event){_vm.submitOpen=$event}},scopedSlots:_vm._u([{key:"foot",fn:function(ref){
var close = ref.close;
return [_c('veui-button',{attrs:{"ui":"primary","loading":_vm.submitting},on:{"click":function($event){return close('ok')}}},[_vm._v("OK")]),_vm._v(" "),_c('veui-button',{attrs:{"disabled":_vm.submitting},on:{"click":close}},[_vm._v("Cancel")])]}}])},[_vm._v("\n    Confirm to create the issue?\n    ")]),_vm._v(" "),_c('veui-dialog',{attrs:{"title":"System","open":_vm.saveOpen,"closable":false,"escapable":!_vm.submitting},on:{"update:open":function($event){_vm.saveOpen=$event}}},[_vm._v("\n    Confirm to save the post?\n    "),_c('template',{slot:"foot"},[_c('veui-button',{attrs:{"ui":"primary","loading":_vm.saving},on:{"click":function($event){return _vm.save('ok')}}},[_vm._v("OK")]),_vm._v(" "),_c('veui-button',{attrs:{"disabled":_vm.saving},on:{"click":_vm.save}},[_vm._v("Cancel")])],1)],2)],1)}
var staticRenderFns = []
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('veui-button',{on:{"click":function($event){_vm.draggableOpen = true}}},[_vm._v("Draggable")]),_vm._v(" "),_c('veui-dialog',{attrs:{"open":_vm.draggableOpen,"title":"Draggable Dialog","draggable":""},on:{"update:open":function($event){_vm.draggableOpen=$event},"ok":function($event){_vm.draggableOpen = false},"cancel":function($event){_vm.draggableOpen = false}}},[_vm._v("\n    This dialog is draggable.\n  ")])],1)}
var staticRenderFns = []
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('veui-button',{on:{"click":function($event){_vm.aOpen = true}}},[_vm._v("Dialog A")]),_vm._v(" "),_c('veui-dialog',{attrs:{"open":_vm.aOpen,"title":"Dialog A","draggable":"","modal":false},on:{"update:open":function($event){_vm.aOpen=$event},"ok":function($event){_vm.aOpen = false},"cancel":function($event){_vm.aOpen = false}}},[_vm._v("\n    The content of Dialog A.\n  ")]),_vm._v(" "),_c('veui-button',{on:{"click":function($event){_vm.bOpen = true}}},[_vm._v("Dialog B")]),_vm._v(" "),_c('veui-dialog',{attrs:{"open":_vm.bOpen,"title":"Dialog B","draggable":"","modal":false},on:{"update:open":function($event){_vm.bOpen=$event},"ok":function($event){_vm.bOpen = false},"cancel":function($event){_vm.bOpen = false}}},[_vm._v("\n    The content of Dialog B.\n  ")])],1)}
var staticRenderFns = []
