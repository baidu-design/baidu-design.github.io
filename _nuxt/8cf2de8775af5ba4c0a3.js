...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('veui-button',{on:{"click":function($event){_vm.modalOpen = true}}},[_vm._v("Modal")]),_c('veui-button',{on:{"click":function($event){_vm.nonModalOpen = true}}},[_vm._v("Non-modal")]),_c('veui-dialog',{attrs:{"title":"System","open":_vm.modalOpen},on:{"update:open":function($event){_vm.modalOpen=$event},"ok":function($event){return _vm.handleModalClose(true)},"cancel":_vm.handleModalClose}},[_vm._v(" Do you want to refresh the page? ")]),_c('veui-dialog',{attrs:{"title":"System","open":_vm.nonModalOpen,"modal":false},on:{"update:open":function($event){_vm.nonModalOpen=$event},"ok":function($event){return _vm.handleModalClose(true)},"cancel":_vm.handleModalClose}},[_vm._v(" Do you want to refresh the page? ")])],1)}
var staticRenderFns = []
...
var modalvue_type_style_index_0_id_212c5c29_lang_less_scoped_true_docs_true_ = __webpack_require__(1008);
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('veui-button',{on:{"click":function($event){_vm.simpleOpen = true}}},[_vm._v("Title & content")]),_c('veui-dialog',{attrs:{"open":_vm.simpleOpen,"title":"Customized Title & Content"},on:{"update:open":function($event){_vm.simpleOpen=$event},"ok":function($event){_vm.simpleOpen = false},"cancel":function($event){_vm.simpleOpen = false}}},[_vm._v(" Customized content via "),_c('code',[_vm._v("<slot>")]),_vm._v(". ")]),_c('veui-button',{on:{"click":function($event){_vm.titleIconOpen = true}}},[_vm._v("Icon in Title")]),_c('veui-dialog',{attrs:{"open":_vm.titleIconOpen},on:{"update:open":function($event){_vm.titleIconOpen=$event},"ok":function($event){_vm.titleIconOpen = false},"cancel":function($event){_vm.titleIconOpen = false}}},[_c('template',{slot:"title"},[_vm._v("Title with Icon "),_c('veui-icon',{attrs:{"name":"top"}})],1),_vm._v(" Customized content via "),_c('code',[_vm._v("<slot>")]),_vm._v(". ")],2),_c('veui-button',{on:{"click":function($event){_vm.footOpen = true}}},[_vm._v("Foot")]),_c('veui-dialog',{attrs:{"open":_vm.footOpen,"title":"Customized Foot"},on:{"update:open":function($event){_vm.footOpen=$event}},scopedSlots:_vm._u([{key:"foot",fn:function(ref){
var close = ref.close;
return [_c('veui-button',{attrs:{"ui":"small primary"},on:{"click":function($event){return close('ok')}}},[_vm._v("Close")])]}}])},[_vm._v(" Customized content via "),_c('code',[_vm._v("<slot>")]),_vm._v(". ")])],1)}
var staticRenderFns = []
...
var icons_top = __webpack_require__(760);
...
var customvue_type_style_index_0_id_47bf8faf_lang_less_scoped_true_docs_true_ = __webpack_require__(1010);
...
var close = ref.close;
return [_c('veui-button',{attrs:{"ui":"primary","loading":_vm.submitting},on:{"click":function($event){return close('ok')}}},[_vm._v("OK")]),_c('veui-button',{attrs:{"disabled":_vm.submitting},on:{"click":close}},[_vm._v("Cancel")])]}}])},[_vm._v(" Confirm to create the issue? ")]),_c('veui-dialog',{attrs:{"title":"System","open":_vm.saveOpen,"closable":false,"escapable":!_vm.submitting},on:{"update:open":function($event){_vm.saveOpen=$event}}},[_vm._v(" Confirm to save the post? "),_c('template',{slot:"foot"},[_c('veui-button',{attrs:{"ui":"primary","loading":_vm.saving},on:{"click":function($event){return _vm.save('ok')}}},[_vm._v("OK")]),_c('veui-button',{attrs:{"disabled":_vm.saving},on:{"click":_vm.save}},[_vm._v("Cancel")])],1)],2)],1)}
var staticRenderFns = []
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./components/demos/demo/dialog/async.vue?vue&type=script&lang=js&
//
//
//
//
...
var asyncvue_type_style_index_0_id_eb446532_lang_less_scoped_true_docs_true_ = __webpack_require__(1012);

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// EXTERNAL MODULE: ./components/demos/demo/dialog/async.vue?vue&type=custom&index=0&blockType=docs
var asyncvue_type_custom_index_0_blockType_docs = __webpack_require__(1014);
...
var asyncvue_type_custom_index_1_blockType_docs_locale_en_US = __webpack_require__(1015);
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('veui-button',{on:{"click":function($event){_vm.draggableOpen = true}}},[_vm._v("Draggable")]),_c('veui-dialog',{attrs:{"open":_vm.draggableOpen,"title":"Draggable Dialog","draggable":""},on:{"update:open":function($event){_vm.draggableOpen=$event},"ok":function($event){_vm.draggableOpen = false},"cancel":function($event){_vm.draggableOpen = false}}},[_vm._v(" This dialog is draggable. ")])],1)}
var staticRenderFns = []
...
var draggablevue_type_style_index_0_id_4dbfed90_lang_less_scoped_true_docs_true_ = __webpack_require__(1016);
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('veui-button',{on:{"click":function($event){_vm.aOpen = true}}},[_vm._v("Dialog A")]),_c('veui-dialog',{attrs:{"open":_vm.aOpen,"title":"Dialog A","draggable":"","modal":false},on:{"update:open":function($event){_vm.aOpen=$event},"ok":function($event){_vm.aOpen = false},"cancel":function($event){_vm.aOpen = false}}},[_vm._v(" The content of Dialog A. ")]),_c('veui-button',{on:{"click":function($event){_vm.bOpen = true}}},[_vm._v("Dialog B")]),_c('veui-dialog',{attrs:{"open":_vm.bOpen,"title":"Dialog B","draggable":"","modal":false},on:{"update:open":function($event){_vm.bOpen=$event},"ok":function($event){_vm.bOpen = false},"cancel":function($event){_vm.bOpen = false}}},[_vm._v(" The content of Dialog B. ")])],1)}
var staticRenderFns = []
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./components/demos/demo/dialog/stack.vue?vue&type=script&lang=js&
//
//
//
//
...
var stackvue_type_style_index_0_id_d070d318_lang_less_scoped_true_docs_true_ = __webpack_require__(1018);

// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// EXTERNAL MODULE: ./components/demos/demo/dialog/stack.vue?vue&type=custom&index=0&blockType=docs
var stackvue_type_custom_index_0_blockType_docs = __webpack_require__(1020);
...
var stackvue_type_custom_index_1_blockType_docs_locale_en_US = __webpack_require__(1021);
