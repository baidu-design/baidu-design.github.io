...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('section',[_c('h4',[_vm._v("Custom label")]),_vm._v(" "),_c('veui-tree',{attrs:{"datasource":_vm.coffees,"item-click":"toggle"},scopedSlots:_vm._u([{key:"item-label",fn:function(ref){
var item = ref.item;
return [_c('i',[_vm._v(_vm._s(item.label))])]}}])})],1),_vm._v(" "),_c('section',[_c('h4',[_vm._v("Custom item")]),_vm._v(" "),_c('veui-tree',{staticClass:"custom-item",attrs:{"datasource":_vm.coffees,"item-click":"toggle"},scopedSlots:_vm._u([{key:"item",fn:function(ref){
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('section',[_c('h4',[_vm._v("Item click")]),_vm._v(" "),_c('veui-radio-group',{attrs:{"items":_vm.modes},model:{value:(_vm.mode),callback:function ($$v) {_vm.mode=$$v},expression:"mode"}})],1),_vm._v(" "),_c('section',[_c('h4',[_vm._v("Expanded items")]),_vm._v("\n    "+_vm._s(_vm.expanded)+"\n  ")]),_vm._v(" "),_c('section',[_c('veui-tree',{attrs:{"datasource":_vm.coffees,"item-click":_vm.mode,"expanded":_vm.expanded},on:{"update:expanded":function($event){_vm.expanded=$event}}})],1)])}
var staticRenderFns = []
