...
var label = ref.label;
return [(children && children.length)?_c('veui-icon',{attrs:{"name":expanded ? 'minus' : 'plus'}}):_vm._e(),_vm._v(" "+_vm._s(label)+" ")]}}])})],1)])}
var staticRenderFns = []
...
var custom_itemvue_type_style_index_0_id_a080d36a_lang_less_scoped_true_docs_true_ = __webpack_require__(1183);

// EXTERNAL MODULE: ./components/demos/demo/tree/custom-item.vue?vue&type=style&index=1&id=a080d36a&lang=less&scoped=true&
var custom_itemvue_type_style_index_1_id_a080d36a_lang_less_scoped_true_ = __webpack_require__(1185);
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('article',[_c('section',[_c('h4',[_vm._v("Item click")]),_c('veui-radio-group',{attrs:{"items":_vm.modes},model:{value:(_vm.mode),callback:function ($$v) {_vm.mode=$$v},expression:"mode"}})],1),_c('section',[_c('h4',[_vm._v("Expanded items")]),_vm._v(" "+_vm._s(_vm.expanded)+" ")]),_c('section',[_c('veui-tree',{attrs:{"datasource":_vm.coffees,"item-click":_vm.mode,"expanded":_vm.expanded},on:{"update:expanded":function($event){_vm.expanded=$event}}})],1)])}
var staticRenderFns = []
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./components/demos/demo/tree/default.vue?vue&type=script&lang=js&
//
//
//
//
...
var defaultvue_type_style_index_0_id_2275ea24_lang_less_scoped_true_docs_true_ = __webpack_require__(1181);
